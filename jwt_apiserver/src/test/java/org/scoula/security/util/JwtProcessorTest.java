...
class JwtProcessorTest {
    ...
    void getUsername() {
        //  실제 테스트에서 생성된 토큰 사용
        String token = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyMCIsImlhdCI6MTc4MjcxMjkyNCwiZXhwIjoxNzgyNzEzMTA0fQ.cWH52LJdlKhYGLYaaLSYrV2EIj7FOWsZf_uKi98RH3k";
    ...
    /* 3분 경과 후 테스트 (수동으로 만료된 토큰 사용) */
    @Test
    void validateToken_Expired() {
        String expiredToken = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJ1c2VyMCIsImlhdCI6MTc4MjcxMjkyNCwiZXhwIjoxNzgyNzEzMTA0fQ.cWH52LJdlKhYGLYaaLSYrV2EIj7FOWsZf_uKi98RH3k";
