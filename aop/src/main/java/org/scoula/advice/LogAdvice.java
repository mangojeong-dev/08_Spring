...
public class LogAdvice {
    ...
    //@After("execution(* org.scoula.weather.controller.WeatherController*.*(..))")
...
*/
    ...
    public Object logTime(ProceedingJoinPoint pjp) {
        // ProceedingJoinPoint : @Around 어드바이스 사용 시 대상 메서드의 시점을 조절하도록 하는 JoinPoint 객체
        // JoinPoint : AOP의 부가기능이 적용된 대상의
